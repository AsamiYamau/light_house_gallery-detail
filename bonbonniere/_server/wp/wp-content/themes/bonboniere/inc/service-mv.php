...
if (is_tax('tax_cake_cat')) {
  ...
  $en_ttl = SCF::get_term_meta($term_id, 'tax_cake_cat', 'en_ttl');
  $thumbnail_id = SCF::get_term_meta($term_id, 'tax_cake_cat', 'thumbnail');
  $catch = SCF::get_term_meta($term_id, 'tax_cake_cat', 'catch');
  $introduction = SCF::get_term_meta($term_id, 'tax_cake_cat', 'introduction');
  ...
  <div class="inner-block">
    ...
    <h1 class="c-ttl02 ptn_orange">
      <span class="dec">
        ...
        <p class="en">SEMI ORDER SERVICE</p>

      <div class="ja">セミオーダーサービス</div>
    </h1>
