    ...
    <div class="inner-block">
      ...
      <div class="p_service-sec01__box01">
        <div class="p_service-sec01__left">
          <div class="p_service-sec01__ttl js-tab-trigger <?= $usage !== 'foryou' ? 'is-active' : ''; ?>" data-tab="tab1">
            <p class="en">FOR COMPANY</p>
            <p class="ja">法人・団体様向け</p>
          </div>
        </div>
        <div class="p_service-sec01__right">
          <div class="p_service-sec01__ttl js-tab-trigger <?= $usage == 'foryou' ? 'is-active' : ''; ?> " data-tab="tab2">
