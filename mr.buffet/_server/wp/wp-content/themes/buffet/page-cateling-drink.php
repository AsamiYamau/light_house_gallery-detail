...
<div class="l-main">
  ...
  <div class="l-main__main">
    <main class="outer-block p_drink-option p_drink bg_img">
      <section class="l-mv">
        <div class="l-mv__img">
          <img src="<?= $template_url; ?>/img/drink/cate_mv.jpg" alt="" />
        </div>
        <div class="l-mv__txt">
          <div class="inner-block02">
            <h1 class="l-mv__txtbox anm-right">
              <span class="en">Drink plan</span>
              <span class="ja">ケータリングメニュー ドリンクプラン</span>
            </h1>
          </div>
        </div>
      </section>
      <div class="c-bread">
        <div class="inner-block">
          <ul class="c-bread-list">
            ...
            <li class="c-bread-list__li">
              <span class="c-bread-list__txt">ドリンクプラン</span>
            </li>
          </ul>
        </div>
      </div>

      <div class="l-kv ptn01 height">
        <div class="l-kv__img height">
        ...
        <div class="l-kv__txt-box">
          ...
          <h2 class="l-kv__ttl anm">
            <span class="big">フリードリンクプラン</span>

          </h2>
          <div class="l-kv__cap anm">
            ワイン、焼酎、ウィスキー、ハイボール、<br class="sp">ソフトドリンクなど<br>
            豊富なドリンクを取り揃えております。<br>
            <span class="kome">
              ※飲み放題は2時間制となっておりますが延長も可能です。<br>またドリンクのみのケータリングも承っております。
            </span>
          </div>
          <div class="l-kv__btn anm-list">
            <div class="btn size-big">
              <a href="#drink01" class="c-btn02 bg_img ico1 mini anchor black">飲み放題メニュー</a>
            </div>
            <div class="btn size-big">
              <a href="#drink02" class="c-btn02 bg_img ico1 mini anchor black">単品メニュー</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="p_drink__cont" id="drink01">
        <div class="inner-block">
          <div class="c-ttl-ribon anm-up">
            <div class="c-ttl-ribon__en Allura">All you can</div>
            <div class="c-ttl-ribon__ja">飲み放題メニュー</div>
          </div>
          <?php
            ...
            <?php while ($drink_plan_query->have_posts()) : $drink_plan_query->the_post(); ?>
              <div class="p_drink-box anm-up">
                ...
                <div class="p_drink-box__wrap">
                  <div class="p_drink-box__img-area">
                    <div class="p_drink-box__txt">
                      <?php echo nl2br(get_field('cateling-drink-plan-catch')); ?>
                    </div>
                  ...
                  <div class="p_drink-box__menu">
                    <div class="c-menu-name mini">
                      <div class="c-menu-name__ttl">ドリンク内容</div>
                      <?php $plan_drinks = get_field('cateling-drink-plan-menu'); ?>
                      <?php if ($plan_drinks): ?>
                        <ul class="c-menu-name-list one">
                          <?php foreach ($plan_drinks as $plan_drink): ?>
                            <li class="c-menu-name-list__item no_flex">
                              <?php if (isset($plan_drink['cateling-drink-plan-menu-name'])): ?>
                                <span class="list-ttl"><?php echo $plan_drink['cateling-drink-plan-menu-name'] ?></span>
                              <?php endif; ?>
                              <?php if (isset($plan_drink['cateling-drink-plan-menu-desc'])): ?>
                                <span class="list-txt"><?php echo nl2br($plan_drink['cateling-drink-plan-menu-desc']); ?></span>
                              <?php endif; ?>
                            </li>
                          <?php endforeach; ?>
                        </ul>
                ...
                <div class="p_drink-box__price">
                  <div class="c-view-more bg_img none_arrow">
      ...
      <div class="l-kv p_drink-option__kv ptn02" id="drink02">
        <div class="l-kv__img">
